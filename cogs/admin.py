                ...
                for resin in resin_notification:
                    try:
                        await self.bot.pool.execute(
                            ...
                            resin["uid"],
                            resin["user_id"],
                            None if not resin["last_notif_time"] else dateutil.parser.parse(resin["last_notif_time"]),
                            resin["current"],
                            resin["max"],
                ...
                for pot in pot_notification:
                    try:
                        await self.bot.pool.execute(
                            ...
                            pot["uid"],
                            pot["user_id"],
                            None if not pot["last_notif_time"] else dateutil.parser.parse(pot["last_notif_time"]),
                            pot["current"],
                            pot["max"],
                ...
                for pt in pt_notification:
                    try:
                        await self.bot.pool.execute(
                            ...
                            pt["uid"],
                            pt["user_id"],
                            None if not pt["last_notif"] else dateutil.parser.parse(pt["last_notif"]),
                            pt["current"],
                            pt["max"],
