...
async def calculateDamage(enka_data, chara_name: str, browser):
    ...
    # hutao has staff of homa
    if chara_name == 'HuTao' and any(d['key'] == 'StaffOfHoma' for d in good_format['weapons']):
    ...
    # ayaka has Mistsplitter Reforged:
    if chara_name == 'KamisatoAyaka' and any(d['key'] == 'MistsplitterReforged' for d in good_format['weapons']):
