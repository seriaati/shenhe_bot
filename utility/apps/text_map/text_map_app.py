...
class TextMap():
    def __init__(self):
        with open('utility/apps/text_map/maps/shenhe_text_map.yaml', 'r', encoding='utf-8') as f:
            self.textMap = yaml.full_load(f)
        with open('utility/apps/text_map/maps/avatar.json', 'r', encoding='utf-8') as f:
            self.avatar = json.load(f)
        with open('utility/apps/text_map/maps/material.json', 'r', encoding='utf-8') as f:
            self.material = json.load(f)
        with open(f'utility/apps/text_map/maps/weapon.json', 'r', encoding='utf-8') as f:
            self.weapon = json.load(f)
        with open(f'utility/apps/text_map/maps/dailyDungeon.json', 'r', encoding='utf-8') as f:
