...
class GenshinApp:
        ...
        try:
            ...
            return (
                error_embed().set_author(
                    name=text_map.get(40, locale, user_locale), icon_url=user.avatar
                ),
                False,
            )
            ...
            return (
                default_embed(
                    ...
                    name=text_map.get(42, locale, user_locale), icon_url=user.avatar
                ),
                True,
            )
    ...
    async def get_real_time_notes(self, user_id: int, locale: Locale):
        ...
        try:
            ...
            return (
                self.parse_resin_embed(notes, locale, user_locale).set_author(
                    name=text_map.get(24, locale, user_locale), icon_url=user.avatar
                ),
                True,
            )

    def parse_resin_embed(
    ...
    async def get_area(
        ...
        return (
            result.set_author(
                name=text_map.get(58, locale, user_locale), icon_url=user.avatar
            ),
            True,
        )
    ...
    async def get_diary(self, user_id: int, month: int, locale: Locale):
        ...
        try:
            ...
            result.add_field(
                name=text_map.get(65, locale, user_locale), value=msg, inline=False
            )
            result.add_field(
            ...
            result.set_author(
                name=f"{text_map.get(69, locale, user_locale)} • {get_month_name(month, locale, user_locale)}",
    ...
    async def get_diary_logs(self, user_id: int, locale: Locale):
        ...
        try:
            ...
            embed.set_author(
                name=text_map.get(70, locale, user_locale), icon_url=user.avatar
            )
            result.append(embed)
            moraLog = ""
            async for action in client.diary_log(
            ...
            embed.set_author(
                name=text_map.get(72, locale, user_locale), icon_url=user.avatar
            )
            result.append(embed)
        return result, True
    ...
    async def get_abyss(
        ...
        try:
            ...
            if len(rank.most_kills) == 0:
                result = error_embed(
                    message=f"{text_map.get(74, locale, user_locale)}\n"
    ...
    async def set_resin_notification(
        ...
        try:
            ...
            if resin_notification_toggle == 0:
                ...
                result = default_embed().set_author(
                    name=text_map.get(98, locale, user_locale), icon_url=user.avatar
                )
            else:
                await c.execute(
                ...
                toggle_str = (
                    text_map.get(99, locale, user_locale)
                    if resin_notification_toggle == 1
                    else text_map.get(100, locale, user_locale)
                )
                result = default_embed(
                ...
                result.set_author(
                    name=text_map.get(104, locale, user_locale), icon_url=user.avatar
                )
            await self.db.commit()
        return result, True
    ...
    async def set_pot_nofitication(
        ...
        try:
            ...
            if toggle == 0:
                ...
                result = default_embed().set_author(
                    name=text_map.get(517, locale, user_locale), icon_url=user.avatar
                )
            else:
                await c.execute(
                ...
                result = default_embed(
                    message=f"{text_map.get(101, locale, user_locale)}: {text_map.get(99, locale, user_locale)}\n"
                    f"{text_map.get(516, locale, user_locale)}: {threshold}\n"
                    f"{text_map.get(103, locale, user_locale)}: {max_notif}"
                )
                result.set_author(
                    name=text_map.get(104, locale, user_locale), icon_url=user.avatar
    ...
    async def redeem_code(self, user_id: int, code: str, locale: Locale):
        ...
        try:
            ...
            return (
                error_embed().set_author(
                    name=text_map.get(106, locale, user_locale), icon_url=user.avatar
                ),
                False,
            )
            ...
            return (
                default_embed(
                    ...
                    name=text_map.get(109, locale, user_locale), icon_url=user.avatar
                ),
                True,
            )
    ...
    async def get_activities(self, user_id: int, custom_uid: int, locale: Locale):
        ...
        try:
            ...
            if summer is None:
                return (
                    error_embed().set_author(
                        name=text_map.get(110, locale, user_locale),
                        icon_url=user.avatar,
                    ),
                    False,
                )
            result = await self.parse_summer_embed(
                summer, user, custom_uid, locale, user_locale
            )
            return result, True
    ...
    async def parse_summer_embed(
        ...
        embeds = []
        embed = default_embed().set_author(
            name=text_map.get(111, locale, user_locale), icon_url=user.avatar
        )
        embed.add_field(
        ...
        for memory in memories:
            embed = default_embed().set_author(
                name=text_map.get(117, locale, user_locale), icon_url=user.avatar
            )
        ...
        for realm in realms:
            embed = default_embed().set_author(
                name=text_map.get(118, locale, user_locale), icon_url=user.avatar
            )
